export default {
  ...
  COMMON: {
    ...
    ARTICLE_LOCK_BY_LOGIN: 'Login to Read More',
    ARTICLE_LOCK_BY_LOGIN_TIPS: 'This article is for logged-in users only. Please sign in or sign up to unlock the full content.',
