    ...
    <article
      ...
      <div
        ...
        className={
          ...
          ' wow fadeInUp border bg-white dark:bg-[#701E49] flex mb-4 flex-col h-[23rem] md:h-52 md:flex-row  group w-full dark:border-gray-600 hover:border-[#df364e]  dark:hover:border-[#ffd9ef] duration-300 transition-colors justify-between overflow-hidden rounded-xl'
        }>
        {/* 图片封面 */}
        {showPageCover && (
        ...
        <div
          ...
          <header>
            ...
            {post?.category && (
              <div
                className={`flex mb-1 items-center ${showPreview ? 'justify-center' : 'justify-start'} hidden md:block flex-wrap dark:text-gray-300 text-gray-600 hover:text-[#df364e] dark:hover:text-[#ffd9ef]`}>
                <SmartLink
                  passHref
            ...
            <SmartLink
              ...
              passHref
              className={
                ' group-hover:text-[#df364e] dark:hover:text-[#ffd9ef] dark:group-hover:text-[#ffd9ef] text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-xl font-extrabold leading-tight'
              }>
